...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I&apos;m Shreshtha.</span> I&apos;m a{" "}
      ...
      >
        ...
        <a
          className="bg-white p-4 text-gray-700 flex hover:text-gray-950 items-center gap-2 text-[1.35rem] rounded-full borderBlack focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer "
          href="https://github.com/afkshreshtha"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
